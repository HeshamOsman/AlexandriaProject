...
public class PageAuthorization {
    ...
    static {
        ...
        PERMISSIONSMAP.put("viewSuggestion.xhtml", "suggestion", "list", Boolean.TRUE);
        PERMISSIONSMAP.put("viewUser.xhtml", "super", "all", Boolean.TRUE);
        PERMISSIONSMAP.put("homePage.xhtml", "super", "all", Boolean.TRUE);
        PERMISSIONSMAP.put("template.xhtml", "super", "all", Boolean.TRUE);
